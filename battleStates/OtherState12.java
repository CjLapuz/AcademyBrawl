...
import characters.Science;
import characters.SocSci;
...
public class OtherState12 extends BasicGameState {
	private int ID = 21;
	static int delta;
	...
	private SocSci player1;
	private Science player2; 
	...
	public OtherState12(int state) {}
	
	
	@SuppressWarnings("unchecked")
	@Override
	public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
		player1 = new SocSci(1);
		player2 = new Science(2);
