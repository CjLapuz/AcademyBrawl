...
public class OtherState6 extends BasicGameState {
	private int ID = 15;
	static int delta;
	...
	private Science player1; 
	private SocSci player2;
	...
	public OtherState6(int state) {}
	
	
	@SuppressWarnings("unchecked")
	@Override
	public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
		player1 = new Science(1);
		player2 = new SocSci(2);
