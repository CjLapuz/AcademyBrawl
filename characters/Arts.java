...
public class Arts extends HitBox{
	...
	public void init() throws SlickException {
		...
		kAnimationIL = new Animation(new SpriteSheet("res/characters/spritesBlts/idleL.png", 200, 250), 100);
		kAnimationIR = new Animation(new SpriteSheet("res/characters/spritesBlts/idleR.png", 200, 250), 100);
		kAnimationWL = new Animation(new SpriteSheet("res/characters/spritesBlts/walkL.png", 200, 250), 100);
		kAnimationWR = new Animation(new SpriteSheet("res/characters/spritesBlts/walkR.png", 200, 250), 100);
		kAnimationJL = new Animation(new SpriteSheet("res/characters/spritesBlts/jumpL.png", 200, 250), 100);
		kAnimationJR = new Animation(new SpriteSheet("res/characters/spritesBlts/jumpR.png", 200, 250), 100);
		kAnimationLPL = new Animation(new SpriteSheet("res/characters/spritesBlts/punchLL.png", 255, 250), 100);
		kAnimationLPR = new Animation(new SpriteSheet("res/characters/spritesBlts/punchLR.png", 255, 250), 100);
		kAnimationSPL = new Animation(new SpriteSheet("res/characters/spritesBlts/punchSL.png", 200, 250), 100);
		kAnimationSPR = new Animation(new SpriteSheet("res/characters/spritesBlts/punchSR.png", 200, 250), 100);
		kAnimationLKL = new Animation(new SpriteSheet("res/characters/spritesBlts/kickLL.png", 255, 250), 100);
		kAnimationLKR = new Animation(new SpriteSheet("res/characters/spritesBlts/kickLR.png", 255, 250), 100);
		kAnimationSKL = new Animation(new SpriteSheet("res/characters/spritesBlts/kickSL.png", 200, 250), 100);
		kAnimationSKR = new Animation(new SpriteSheet("res/characters/spritesBlts/kickSR.png", 200, 250), 100);
		kAnimationDPL = new Animation(new SpriteSheet("res/characters/spritesBlts/duckPL.png", 200, 250), 100); 
		kAnimationDPR = new Animation(new SpriteSheet("res/characters/spritesBlts/duckPR.png", 200, 250), 100); 
		kAnimationDKL = new Animation(new SpriteSheet("res/characters/spritesBlts/duckKL.png", 200, 250), 100);
		kAnimationDKR = new Animation(new SpriteSheet("res/characters/spritesBlts/duckKR.png", 200, 250), 100);
		kAnimationTL = new Animation(new SpriteSheet("res/characters/spritesBlts/throwL.png", 255, 250), 100);
		kAnimationTR = new Animation(new SpriteSheet("res/characters/spritesBlts/throwR.png", 255, 250), 100);
		kAnimationWin = new Animation(new SpriteSheet("res/characters/spritesBlts/win.png", 200, 250), 250);
		
		hitL = new Image("res/characters/spritesBlts/hitBL.png");
		hitR = new Image("res/characters/spritesBlts/hitBR.png");
		hitDL = new Image("res/characters/spritesBlts/hitDL.png");
		hitDR = new Image("res/characters/spritesBlts/hitDR.png");
		deadL = new Image("res/characters/spritesBlts/deadL.png");
		deadR = new Image("res/characters/spritesBlts/deadR.png");
		duckL = new Image("res/characters/spritesBlts/duckL.png");
		duckR = new Image("res/characters/spritesBlts/duckR.png");
