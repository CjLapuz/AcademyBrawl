...
public class Management extends HitBox{
	...
	public void init() throws SlickException {
		...
		kAnimationIL = new Animation(new SpriteSheet("res/characters/spritesTyc/idleL.png", 200, 250), 100);
		kAnimationIR = new Animation(new SpriteSheet("res/characters/spritesTyc/idleR.png", 200, 250), 100);
		kAnimationWL = new Animation(new SpriteSheet("res/characters/spritesTyc/walkL.png", 227, 250), 100);
		kAnimationWR = new Animation(new SpriteSheet("res/characters/spritesTyc/walkR.png", 227, 250), 100);
		kAnimationJL = new Animation(new SpriteSheet("res/characters/spritesTyc/jumpL.png", 200, 250), 100);
		kAnimationJR = new Animation(new SpriteSheet("res/characters/spritesTyc/jumpR.png", 200, 250), 100);
		kAnimationLPL = new Animation(new SpriteSheet("res/characters/spritesTyc/punchLL.png", 200, 250), 100);
		kAnimationLPR = new Animation(new SpriteSheet("res/characters/spritesTyc/punchLR.png", 200, 250), 100);
		kAnimationSPL = new Animation(new SpriteSheet("res/characters/spritesTyc/punchSL.png", 200, 250), 100);
		kAnimationSPR = new Animation(new SpriteSheet("res/characters/spritesTyc/punchSR.png", 200, 250), 100);
		kAnimationLKL = new Animation(new SpriteSheet("res/characters/spritesTyc/kickLL.png", 200, 250), 100);
		kAnimationLKR = new Animation(new SpriteSheet("res/characters/spritesTyc/kickLR.png", 200, 250), 100);
		kAnimationSKL = new Animation(new SpriteSheet("res/characters/spritesTyc/kickSL.png", 255, 250), 100);
		kAnimationSKR = new Animation(new SpriteSheet("res/characters/spritesTyc/kickSR.png", 255, 250), 100);
		kAnimationDPL = new Animation(new SpriteSheet("res/characters/spritesTyc/duckPL.png", 255, 250), 100); 
		kAnimationDPR = new Animation(new SpriteSheet("res/characters/spritesTyc/duckPR.png", 255, 250), 100); 
		kAnimationDKL = new Animation(new SpriteSheet("res/characters/spritesTyc/duckKL.png", 255, 250), 100);
		kAnimationDKR = new Animation(new SpriteSheet("res/characters/spritesTyc/duckKR.png", 255, 250), 100);
		kAnimationTL = new Animation(new SpriteSheet("res/characters/spritesTyc/throwL.png", 255, 250), 100);
		kAnimationTR = new Animation(new SpriteSheet("res/characters/spritesTyc/throwR.png", 255, 250), 100);
		kAnimationWin = new Animation(new SpriteSheet("res/characters/spritesTyc/win.png", 255, 250), 250);
		
		hitL = new Image("res/characters/spritesTyc/hitBL.png");
		hitR = new Image("res/characters/spritesTyc/hitBR.png");
		hitDL = new Image("res/characters/spritesTyc/hitDL.png");
		hitDR = new Image("res/characters/spritesTyc/hitDR.png");
		deadL = new Image("res/characters/spritesTyc/deadL.png");
		deadR = new Image("res/characters/spritesTyc/deadR.png");
		duckL = new Image("res/characters/spritesTyc/duckL.png");
		duckR = new Image("res/characters/spritesTyc/duckR.png");
