...
public class SocSci extends HitBox{
	...
	public void init() throws SlickException {
		...
		kAnimationIL = new Animation(new SpriteSheet("res/characters/spritesStal/idleL.png", 200, 250), 100);
		kAnimationIR = new Animation(new SpriteSheet("res/characters/spritesStal/idleR.png", 200, 250), 100);
		kAnimationWL = new Animation(new SpriteSheet("res/characters/spritesStal/walkL.png", 200, 250), 100);
		kAnimationWR = new Animation(new SpriteSheet("res/characters/spritesStal/walkR.png", 200, 250), 100);
		kAnimationJL = new Animation(new SpriteSheet("res/characters/spritesStal/jumpL.png", 200, 250), 100);
		kAnimationJR = new Animation(new SpriteSheet("res/characters/spritesStal/jumpR.png", 200, 250), 100);
		kAnimationLPL = new Animation(new SpriteSheet("res/characters/spritesStal/punchLL.png", 200, 250), 100);
		kAnimationLPR = new Animation(new SpriteSheet("res/characters/spritesStal/punchLR.png", 200, 250), 100);
		kAnimationSPL = new Animation(new SpriteSheet("res/characters/spritesStal/punchSL.png", 200, 250), 100);
		kAnimationSPR = new Animation(new SpriteSheet("res/characters/spritesStal/punchSR.png", 200, 250), 100);
		kAnimationLKL = new Animation(new SpriteSheet("res/characters/spritesStal/kickLL.png", 227, 250), 100);
		kAnimationLKR = new Animation(new SpriteSheet("res/characters/spritesStal/kickLR.png", 227, 250), 100);
		kAnimationSKL = new Animation(new SpriteSheet("res/characters/spritesStal/kickSL.png", 255, 250), 100);
		kAnimationSKR = new Animation(new SpriteSheet("res/characters/spritesStal/kickSR.png", 255, 250), 100);
		kAnimationDPL = new Animation(new SpriteSheet("res/characters/spritesStal/duckPL.png", 255, 250), 100); 
		kAnimationDPR = new Animation(new SpriteSheet("res/characters/spritesStal/duckPR.png", 255, 250), 100); 
		kAnimationDKL = new Animation(new SpriteSheet("res/characters/spritesStal/duckKL.png", 255, 250), 100);
		kAnimationDKR = new Animation(new SpriteSheet("res/characters/spritesStal/duckKR.png", 255, 250), 100);
		kAnimationTL = new Animation(new SpriteSheet("res/characters/spritesStal/throwL.png", 255, 250), 100);
		kAnimationTR = new Animation(new SpriteSheet("res/characters/spritesStal/throwR.png", 255, 250), 100);
		kAnimationWin = new Animation(new SpriteSheet("res/characters/spritesStal/win.png", 255, 250), 250);
		
		hitL = new Image("res/characters/spritesStal/hitBL.png");
		hitR = new Image("res/characters/spritesStal/hitBR.png");
		hitDL = new Image("res/characters/spritesStal/hitDL.png");
		hitDR = new Image("res/characters/spritesStal/hitDR.png");
		deadL = new Image("res/characters/spritesStal/deadL.png");
		deadR = new Image("res/characters/spritesStal/deadR.png");
		duckL = new Image("res/characters/spritesStal/duckL.png");
		duckR = new Image("res/characters/spritesStal/duckR.png");
